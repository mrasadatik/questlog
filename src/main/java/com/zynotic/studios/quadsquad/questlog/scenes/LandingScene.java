...
public class LandingScene {
    ...
    public LandingScene(SessionManager sessionManager) {
        ...
        if (!sessionManager.isSignedIn()) {
            ...
            aboutModalPane = About.getAboutModal(aboutDialog);
            ...
            ModalPane finalAboutModalPane = aboutModalPane;
            aboutDialogOpenBtn.setOnAction(evt -> finalAboutModalPane.show(aboutDialog));
